...
class voxelServer extends events_1.EventEmitter {
    constructor(opts) {
        super();
        this.updateDelay = 1000 / 3; // every 330ms;
        this.nbUpdate = 0;
        this.settings = {};
        this.game = {};
        this.chunkCache = {};
    ...
    bindClientEvents(client) {
        ...
        client.connection.on('data', function (message) {
            console.log('ici data', message);
        });
        client.connection.on('chat', self.handleErrors(function (message) {
        ...
        client.connection.on('state', self.handleErrors(function (state) {
            console.log(state);
