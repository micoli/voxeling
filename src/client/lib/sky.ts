...
export class Weather {
	sunRotation: number;
	sun: Sun;
	directionalLight: {color: any; start: any; position: any; };
	ambientLightTypes: {dark: any; dawn: any; full: any; dusk: any; };
	lightTypes: {dark: any; dawn: any; full: any; dusk: any; };
	...
	render(projection:any, ts:number) {
		var gl = this.gl;
